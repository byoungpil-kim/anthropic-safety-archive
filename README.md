...
사이트: https://byoungpil-kim.github.io/anthropic-safety-archive/

`main` 브랜치에 변경사항을 올리면 GitHub Actions에서 빌드한 뒤 GitHub Pages에 자동 배포한다.
...
2026년 9월 16일 공개 원문을 대조한 [검토 범위와 수정 기록](VERIFICATION.md)을 제공한다. 각 판본 페이지 상단에서 공식 원문으로 이동할 수 있다.
